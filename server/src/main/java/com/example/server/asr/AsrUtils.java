...
public class AsrUtils {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AsrUtils.class);
    public static String result;

    public AsrUtils(String appKey, String id, String secret, String url) {
        this.appKey = appKey;
    ...
    private static SpeechTranscriberListener getTranscriberListener() {
        SpeechTranscriberListener listener = new SpeechTranscriberListener() {
            ...
            public void onTranscriptionResultChange(SpeechTranscriberResponse response) {
                ...
                System.out.println("onTranscriptionResultChange========中间结果："+response.getTransSentenceText());
            }
            ...
            public void onSentenceEnd(SpeechTranscriberResponse response) {
                System.out.println("task_id: " + response.getTaskId() +
                        ...
                        ", time: " + response.getTransSentenceTime());
                result = response.getTransSentenceText();
                System.out.println("onSentenceEnd========句子结束："+result);
            }
            ...
            public void onTranscriptionComplete(SpeechTranscriberResponse response) {
                System.out.println("task_id: " + response.getTaskId() + ", name: " + response.getName() + ", status: " + response.getStatus());
                String result1 = response.getTransSentenceText();
                System.out.println("onTranscriptionComplete========识别完毕："+result1);
            }
