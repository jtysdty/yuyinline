package com.example.server.tts;
 ...
 *      首包延迟计算。
 */
public class AliTextToSpeech {
    private static final Logger logger = LoggerFactory.getLogger(AliTextToSpeech.class);
    private static long startTime;
    private String appKey;
    NlsClient client;
    public AliTextToSpeech(String appKey, String accessKeyId, String accessKeySecret) {
        this.appKey = appKey;
    ...
    public AliTextToSpeech(String appKey, String accessKeyId, String accessKeySecret, String url) {
        this.appKey = appKey;
        AccessToken accessToken = new AccessToken(accessKeyId, accessKeySecret);
        try {
            accessToken.apply();
    ...
    private static SpeechSynthesizerListener getSynthesizerListener() {
        ...
        try {
            listener = new SpeechSynthesizerListener() {
                File f=new File("D:/test/AudioFile/ttsfeedback.wav");
                ...
                public void onMessage(ByteBuffer message) {
                    try {
                        if(firstRecvBinary) {
                            ...
                            logger.info("tts first latency : " + (now - AliTextToSpeech.startTime) + " ms");
                        }
    ...
    public void process(String msg) {
        ...
        try {
            ...
            AliTextToSpeech.startTime = System.currentTimeMillis();
            //等待语音合成结束
